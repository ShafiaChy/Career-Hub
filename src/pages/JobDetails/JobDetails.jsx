...
const JobDetails = () => {
    ...
    return (
        <div >
           ...
           <div className="grid md:grid-cols-4 gap-4 my-24 md:px-24">
            ...
            <div>
                <div className="px-12 py-8  bg-slate-100 rounded-md">
                    <h2 className="font-bold my-2">Job Details</h2>
                    <hr />
                    <ul className="mt-2 space-y-2">
                        <li><span className="text-black font-semibold">Salary: </span> {data[0].salary}</li>
                        <li><span className="text-black font-semibold">Job Title:</span>:  {data[0].job_title}</li>
                    </ul>

                    <h2 className="font-bold my-2">Contact Information</h2>
                    <hr />
                    <ul className="mt-2 space-y-2">
                        <li><span className="text-black font-semibold">Phone:</span> {data[0].contact_information.phone}</li>
                        <li><span className="text-black font-semibold">Email:</span> {data[0].contact_information.email}</li>
                        <li><span className="text-black font-semibold">Address:</span> {data[0].contact_information.address}</li>
                    </ul>
